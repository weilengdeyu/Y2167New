...
<div class="w-main m-auto m-t-37 m-b-25 ovhidden">
    <!--web logo start-->
    <a href="${pageContext.request.contextPath}/getCourseData" class="logo fl">
...
<div class="w-all w-minw hg-60 bg-c-ffffff ql_webnav">
    <div class="w-main m-auto ps-r hg-60">
        <!--全部商品分类-->
        <div class="hc_lnav jslist" style="float:right;opacity: 0.5;">
            <div class="allbtn">
             <%--   <img class="lazy newsImg" src="${pageContext.request.contextPath}/front/images/notes.png"  style="display: block;">--%>
                <%-- <h2><a href="#">全部课程分类</a></h2>--%>
                <ul style="width:224px;height:350px;background:url('${pageContext.request.contextPath}/front/images/notes.png') no-repeat 0px 0px;border-radius: 25px;" class="jspop box">
                    <h3 style="margin-top: 20px;margin-left: 25px;"><a style="color:white;text-decoration: none;" href="http://www.cnblogs.com/weilengdeyu">微冷的雨博客园</a></h3>
                </ul>
            </div>
        </div>
        <!--导航栏-->
    ...
    <div class="w-main m-auto ovhidden">
        <div class="w-main m-auto bg-c-ffffff ovhidden"> 
            ...
            <div class="w-680 hg-338 m-l-40 ovhidden ps-r fl">
                ...
                <h3 class="w-all fs-24 ftc-000000 m-t-15 m-b-10 line-h36 fl">${course.tCname}</h3>
                <!--info right start-->
                <div class="w-all fl">
                    <ul class="con_rig_class">
                        <li class="w-all fs-14 ftc-000000 line-h40 m-b-10 fl">价&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;格：<span class="fs-24 ftc-e9511b">¥${course.tPrice}</span></li>
                        <div class="claer"></div>
                    </ul>
                </div>
                <!--info right end-->
                <div class="standard ps-a pa-b-22">
                    <a class="dsblock w-140 hg-46 text-c line-h46 bg-c-e9511b ftc-ffffff fs-18 bd-rd-6 m-r-28 fl"id="mybtnBuy" href="javascript:showPayLayer(${course.tPrice});">立即购买</a>
        ...
        <div class="w-main ovhidden">
            ...
            <div class="w-1140 p-l-30 p-r-30 bg-c-ffffff p-b-30 ovhidden">
                ...
                <div class="w-1115 p-l-15 fs-16 line-h26 ftc-636363 fl">针对初一年级学生，根据英语课程，同步并强化提升重要知识点和常见典型题目，做到及时复习，有效的夯实基础。youwin独特方法，帮学员扫清学习障碍。1.帮助学生构建属于自己的个性化学习方案 2.课前精细备课，制定完整教学计划 3.我们承诺当堂课满分过关，不满意不计费 4.每次课结束后会有作业，帮助巩固吸收学习内容。每月进行月考，检测知识学习情况 。 <br/>
                    <br/>
                </div>
                ...
                <div class="w-1115 p-l-15 fs-16 line-h26 ftc-636363 fl"> <br/>
                    题型和提干信息的比对；特殊疑问句表达和书写；句子结构书写； </div>
                <h3 class="fs-16 ft-w-b ftc-e9511b line-26 p-l-15 m-t-15 m-b-15 line_h3 fl">授课内容</h3>
                <div class="w-1115 p-l-15 fs-16 line-h26 ftc-636363 fl"> 1.精编教材，适度定制VIP教案-全国专家智慧的结晶，学科教学前沿的精华；2.先进的教学理念-能力与成绩兼得，成长和成绩并重；3.人性化的教学方法-情景、体验式快乐教学，构建以学生为中心的课堂；4.VIP高端小课教学-给孩子提供大量运用语言的机会，了解每个孩子的个性特点，核心学习力，帮助他们运用的优劣去学习；5.精细的作业批改-让每个孩子体会属于自己的点滴成长。 </div>
            </div>
            <!--课程总览 end--> 
            <!--分割线-->
            <div class="w-amin hg-30 ovhidden"></div>
...
<div class="w-all w-minw bg-c-f6f6f6 ovhidden">
    <div class="w-main m-auto"> 
        ...
        <ul class="ql_likeclass w-1210 ovhidden">
            <li class="w-230 bg-c-ffffff m-t-10 m-r-6 m-l-6 m-b-10 fl"> <a href="#" class="dsblock w-230 hg-165 ovhidden ps-r"> <img src="${pageContext.request.contextPath}/front/pics/12.jpg" alt=""/> </a>
                <div class="w-210 p-l-10 p-r-10 fl">
...
<div class="w-all w-minw bg-c-e3e3e3 p-t-15 ovhidden"> 
    ...
    <div class="w-main m-auto m-b-23 ovhidden">
        <div class="m-t-12 fl"> <a href="#" class="m-t-25 fl"><img src="${pageContext.request.contextPath}/front/pics/footer_logo.png" width="235" height="70" alt=""/></a>
...
<script type="text/javascript">
    ...
    function showPayLayer(price){
        //示范一个公告层
            ...
            ,content: '<div id="box" style="padding: 50px; line-height: 22px; background-color: #FFFFFF;' +
            ' color: black; font-weight: 300;">课程价格： ¥'+price+'<hr/>请选择支付方式<br/><br/><div style="float:left;" class="zfb"><img src="${pageContext.request.contextPath}/front/images/alipay.png"></div><div  style="float:left;margin-left:20px;cursor:pointer;"><img src="${pageContext.request.contextPath}/front/images/wechat.png"></div></div>'
            ,success: function(layero){
                    $("#box").on("click","div",function () {
                         $(this).siblings().removeClass("zfb");
                        $(this).addClass("zfb");
                    });
