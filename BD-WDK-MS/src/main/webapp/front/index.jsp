...
<div class="w-all w-minw banner ps-r">
    <div id="full-screen-slider">
        <ul id="slides">
            <li style="background:url('${pageContext.request.contextPath}/jsp/front/pics/ban1.jpg') center top no-repeat;">
                <a href="javascript:void(0)"></a></li>
            <li style="background:url('${pageContext.request.contextPath}/jsp/front/pics/ban2.jpg') center top no-repeat;"><a href="javascript:void(0)"></a></li>
            <li style="background:url('${pageContext.request.contextPath}/jsp/front/pics/ban3.jpg') center top no-repeat;"><a href="javascript:void(0)"></a></li>
        </ul>
    </div>
</div>
    ...
    <div class="w-main m-auto">
        <ul class="home_calss w-1224 ovhidden">
                <c:forEach items="${videos}" var="item">
                    <li class="w-280 m-l-13 m-r-13 bg-c-ffffff m-t-8 m-b-23 fl"> <a href="${pageContext.request.contextPath}/getDetailCourseById/${item.tCid}" class="dsblock w-280 hg-200 ovhidden ps-r"> <img src="pics/12.jpg" alt=""/> </a>
                        <div class="w-255 p-l-10 p-r-15 fl">
                            <div class="home_calsstxt w-155 fl">
                                ...
                                <span class="dsblock w-all fs-14 ftc-ff0000 line-h32 fl">${item.tCcomment}</span> </div>
                        </div>
                    </li>
                </c:forEach>
            <div class="clear"></div>
