...
<!--齐峰的共有样式-->
    ...
    <script type="text/javascript">
       ...
       $(function () {
         ...
         /*  $("#mybtnBuy").click(function () {
               var aa=$(".zfb")[0].innerHTML;
               alert(aa);
           });*/
...
<div class="w-main m-auto m-t-37 m-b-25 ovhidden"> 
    <!--web logo start--> 
    <a href="index.html" class="logo fl"><img src="pics/ql_logo.gif" width="240" height="70" alt="老原教育logo(图)"/></a>
    <!--web logo end--> 
    <!--web search start-->
    ...
    <!--web search end-->
    <div class="fr"> <img src="pics/top_tel.gif" width="199" height="70" alt="老原教育400电话"/> </div>
</div>
    ...
    <div class="w-main m-auto ovhidden">
        <div class="w-main m-auto bg-c-ffffff ovhidden"> 
            ...
            <div class="w-680 hg-338 m-l-40 ovhidden ps-r fl">
                ...
                <h3 class="w-all fs-24 ftc-000000 m-t-15 m-b-10 line-h36 fl">${oneVideo.tVname}</h3>
                <!--info right start-->
                <div class="w-all fl">
                    <ul class="con_rig_class">
                        <li class="w-all fs-14 ftc-000000 line-h40 m-b-10 fl">价&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;格：<span class="fs-24 ftc-e9511b">¥${oneVideo.tVprice}</span></li>
                        <div class="claer"></div>
                    </ul>
                </div>
                <!--info right end-->
                <div class="standard ps-a pa-b-22">
                    <a class="dsblock w-140 hg-46 text-c line-h46 bg-c-e9511b ftc-ffffff fs-18 bd-rd-6 m-r-28 fl"id="mybtnBuy" href="javascript:showPayLayer(${oneVideo.tVprice});">立即购买</a>
