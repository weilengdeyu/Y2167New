 ...
 * Created by Happy on 2018-04-06.
 */
...
public class OriginalMD5Utils {
    ...
    public static void main(String args[]) {
        OriginalMD5Utils m = new OriginalMD5Utils();
        String md5 = m.getkeyBeanofStr("1");
