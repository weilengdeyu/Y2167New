...
public class RefUtil {
	 @SuppressWarnings("unchecked")  
	    public static Field[] getProperty(Object entityName) throws Exception {  
     ...
     * @throws Exception 
     */
    public  static <T> void  veryhappy(T stu,ResultSet rs) throws Exception{
    	//01
		 Map<String, String> valMap = new HashMap<String, String>(); 
    	 Field[] propertys = RefUtil.getProperty(stu);
		 for (Field field : propertys) {
			 valMap.put(field.getName(),rs.getString(field.getName()));
		 }
		 RefUtil.setFieldValue(stu, valMap);
    }
