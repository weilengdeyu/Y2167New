...
<html>
     ...
     var data=new Array();  
	  ...
	  /*   data.push=function(o){  
       ...
       function checkGenerator() {
           ...
           if(txtRow.value==""||txtRow.value==null){
               alert('请输入行数');
               return false;
           }
           if(txtColumn.value==""||txtColumn.value==null){
               alert('请输入列数');
               return false;
           }

           var row=parseInt(txtRow.value);
           var col=parseInt(txtColumn.value);
           //输入合法，调度js方法
           initOptions(row,col);
           return true;
       }
       ...
       //加载完所有的标签，图片和css后执行
        window.onload=function(){
            var mybtn=document.getElementById("btngenerate");
        ...
        var mydata=document.getElementById("selectData");
         ...
         if(col>3){
           mybody.style.width=document.body.scrollWidth+(col-3)*350;
         }
  ...
  <body id="mybody">
     ...
     <div id="container">
         <fieldset>
             <legend style="color:red;">答题区 :本软件由微冷的雨出品!如有问题，请发送反馈信息到：yymqqc@126.com</legend>
      <div id="box">
        ...
        <form action="${pageContext.request.contextPath}/SaveServlet?action=save" method="post" id="form1">
		     <div id="tool">
		           ...
		           <input type="button" id="btngenerate" value="生成"/>
